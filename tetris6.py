...
def judge_move_right(current_block, current_block_start_row, current_block_start_col, stop_all_block_list):
    ...
    for col in range(len(current_block[0]) - 1, -1, -1):
        ...
        if (('A' in col_list) or ('B' in col_list) or ('C' in col_list) or ('D' in col_list) or ('E' in col_list) or ('F' in col_list) or ('G' in col_list)):
            ...
            for j in indices:
                if ((stop_all_block_list[current_block_start_row+j][current_block_start_col+col] == 'A') or (stop_all_block_list[current_block_start_row+j][current_block_start_col+col] == 'B') or (stop_all_block_list[current_block_start_row+j][current_block_start_col+col] == 'C') or (stop_all_block_list[current_block_start_row+j][current_block_start_col+col] == 'D') or (stop_all_block_list[current_block_start_row+j][current_block_start_col+col] == 'E') or (stop_all_block_list[current_block_start_row+j][current_block_start_col+col] == 'F') or (stop_all_block_list[current_block_start_row+j][current_block_start_col+col] == 'G')):
                    return False
...
def ai_suggest_best_position(current_block_1, stop_all_block_list, current_block_start_row_1, current_block_start_col_1):
    ...
    print("BEST")
    print(best_score,best_col,best_rotation)
...
def ai_suggest_best_position(current_block_1, stop_all_block_list, current_block_start_row_1, current_block_start_col_1):
    ...
    for rotation in range(4):
        ...
        for col in range(BLOCK_COL_NUM - len(current_block[0]) + 1):
            ...
            while judge_move_down(current_block, current_block_start_row_1 + 1, col,
                                  temp_board):
                current_block_start_row_1 += 1

            add_to_stop_all_block_list(temp_board, current_block, current_block_start_row_1, col)
    ...
    return best_col_list, best_rotation, current_block_1
...
def main():
    ...
    pygame.mixer.init()
    pygame.mixer.music.load("/Users/kevinabeykoon/PycharmProjects/PythonProject/tetris_music.mp3")
    ...
    # font
    font = pygame.font.Font("/Users/kevinabeykoon/PycharmProjects/PythonProject/PokemonGb-RAeo.ttf", 20)
    game_over_font = pygame.font.Font("/Users/kevinabeykoon/PycharmProjects/PythonProject/PokemonGb-RAeo.ttf", 20)
    ...
    while True:
        ...
        # Game information
        #logo
        image = pygame.image.load("/Users/kevinabeykoon/PycharmProjects/PythonProject/Tetr.ai_Logo.png").convert()
        ...
        # AI Hint
        if ai_check:
            hint_show_msg = font.render('AI HINT: ', True, (255, 255, 255))
            screen.blit(hint_show_msg, (BLOCK_COL_NUM * SIZE + 10, 500))
            hint_show_msg = font.render('Rotation: ', True, (255, 255, 255))
            screen.blit(hint_show_msg, (BLOCK_COL_NUM * SIZE + 10, 525))
            hint_show_msg = font.render(str(best_rotation), True, (255, 255, 255))
            screen.blit(hint_show_msg, (BLOCK_COL_NUM * SIZE + 10, 550))

            hint_show_msg = font.render('Column: ', True, (255, 255, 255))
            screen.blit(hint_show_msg, (BLOCK_COL_NUM * SIZE + 10, 575))
            hint_show_msg = font.render(str(best_col_list), True, (255, 255, 255))
