        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                if event.key == pygame.K_p:
                    ...
                    best_col, best_rotation, best_11 = ai_suggest_best_position(current_block, stop_all_block_list,
                                                                       current_block_start_row, current_block_start_col)
                    print(best_col, best_rotation, best_11)
